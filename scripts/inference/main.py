...
# Imports from project package after adjusting sys.path
...
def main(video_path):
    ...
    while cap.isOpened():
        ...
        # Nếu đã đủ 7 bước lịch sử thì dự đoán 10 bước tiếp theo cho từng tracker
        for tracker in trackers:
...
if __name__ == "__main__":
    default_video = os.path.join(ROOT_DIR, "archive 2", "test", "2.mp4")
    main(default_video)
