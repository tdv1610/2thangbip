...
from utils import normalize_input, denormalize_output, draw_boxes, KalmanBoxTracker, get_center, compute_iou
    ...
    while cap.isOpened():
        ...
        for tracker in trackers:
            ...
            if len(tracker.history) == 7:
                seq = np.array(tracker.history)      # Không dùng multi_level_lag_scheme nữa
                norm_input = normalize_input(seq, scaler)
